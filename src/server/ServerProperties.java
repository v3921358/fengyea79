...
public class ServerProperties
{
    ...
    public static void saveProperties() {
        ...
        for (final Entry<java.lang.Object, java.lang.Object> i : ServerProperties.props.entrySet()) {
            ...
            if (((String)i.getKey()).contains((CharSequence)"World")) {
                ...
                ((ArrayList<String>)world.get(WorldConstants.getNameById(worldId))).add(info);
            }
                ...
                ((ArrayList<String>)tespia.get(WorldConstants.getNameById(worldId))).add(info);
            }
