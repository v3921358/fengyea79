...
public class MapleShop
{
    ...
    static {
        ...
        MapleShop.rechargeableItems.remove(Integer.valueOf(2070014));
        MapleShop.rechargeableItems.remove(Integer.valueOf(2070015));
        MapleShop.rechargeableItems.remove(Integer.valueOf(2070016));
        MapleShop.rechargeableItems.remove(Integer.valueOf(2070017));
        MapleShop.rechargeableItems.remove(Integer.valueOf(2070018));
