        ...
        switch (type) {
            ...
            case job: {
                ...
                if (first.length <= 0 && rse.getString("intStoresFirst").length() > 0) {
                    this.dataStore.add(new Pair<Integer, Integer>(Integer.parseInt(rse.getString("intStoresFirst")), Integer.parseInt(rse.getString("intStoresSecond"))));
                }
                for (int i = 0; i < first.length; ++i) {
                    if (first[i].length() > 0 && second[i].length() > 0) {
                        this.dataStore.add(new Pair<Integer, Integer>(Integer.parseInt(first[i]), Integer.parseInt(second[i])));
                    }
                }
                break;
            }
