...
public class MapleLifeFactory
{
    ...
    public static int getNPCLocation(final int npcid) {
        if (MapleLifeFactory.NPCLoc.containsKey(Integer.valueOf(npcid))) {
            return (int)Integer.valueOf(MapleLifeFactory.NPCLoc.get(Integer.valueOf(npcid)));
        }
    ...
    public static final List<Integer> getQuestCount(final int id) {
        return (List<Integer>)MapleLifeFactory.questCount.get(Integer.valueOf(id));
    }
    
    public static MapleMonster getMonster(final int mid) {
        MapleMonsterStats stats = (MapleMonsterStats)MapleLifeFactory.monsterStats.get(Integer.valueOf(mid));
        if (stats == null) {
            ...
            if (mid == 9400296) {
                ...
                stats.setHp(31000000000L);
            }
            else if (mid == 9900002) {
                stats.setHp(99999999999L);
            }
            else if (mid == 9900003) {
                stats.setHp(199999999999L);
            }
            else if (mid == 9900004) {
                stats.setHp(99999999999L);
            }
            ...
            if (monsterSkillData != null) {
                ...
                while (monsterSkillData.getChildByPath(Integer.toString(i)) != null) {
                    final boolean add = skills.add(new Pair<Integer, Integer>(MapleDataTool.getInt(i + "/skill", monsterSkillData, 0), MapleDataTool.getInt(i + "/level", monsterSkillData, 0)));
                    ++i;
                }
