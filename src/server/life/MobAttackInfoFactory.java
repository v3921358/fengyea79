...
public class MobAttackInfoFactory
{
    ...
    public MobAttackInfo getMobAttackInfo(final MapleMonster mob, final int attack) {
        MobAttackInfo ret = (MobAttackInfo)MobAttackInfoFactory.mobAttacks.get(new Pair(mob.getId(), Integer.valueOf(attack)));
        if (ret != null) {
            return ret;
        }
        ...
        MobAttackInfoFactory.mobAttacks.put(new Pair<Integer, Integer>(mob.getId(), Integer.valueOf(attack)), ret);
        return ret;
    }
