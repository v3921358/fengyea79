...
public class MapleMapFactory
{
    ...
    public final MapleMap getMap(final int mapid, final boolean respawns, final boolean npcs, final boolean reactors) {
        ...
        if (map == null) {
            ...
            try {
                ...
                final List<AbstractLoadedMapleLife> custom = (List<AbstractLoadedMapleLife>)MapleMapFactory.customLife.get(Integer.valueOf(mapid));
                if (custom != null) {
            ...
            final List<AbstractLoadedMapleLife> custom2 = (List<AbstractLoadedMapleLife>)MapleMapFactory.customLife.get(Integer.valueOf(mapid));
            if (custom2 != null) {
    ...
    public static int loadCustomLife(final boolean reload, final MapleMap map) {
        if (reload) {
            ...
            final List<AbstractLoadedMapleLife> custom = (List<AbstractLoadedMapleLife>)MapleMapFactory.RemovecustomLife.get(Integer.valueOf(mid));
            if (custom != null) {
                for (final AbstractLoadedMapleLife n : custom) {
                    final String cType = n.getCType();
                    switch (cType) {
        ...
        try (final Connection con = (Connection)DBConPool.getInstance().getDataSource().getConnection()) {
            try (final PreparedStatement ps = con.prepareStatement("SELECT * FROM `wz_customlife`");
                ...
                while (rs.next()) {
                    ...
                    final List<AbstractLoadedMapleLife> entries = (List<AbstractLoadedMapleLife>)MapleMapFactory.customLife.get(Integer.valueOf(mapid));
