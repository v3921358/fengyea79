...
public class MapleReactorFactory
{
    ...
    public static final MapleReactorStats getReactor(final int rid) {
        MapleReactorStats stats = (MapleReactorStats)MapleReactorFactory.reactorStats.get(Integer.valueOf(rid));
        if (stats == null) {
            int infoId = rid;
            ...
            if (link != null) {
                ...
                stats = (MapleReactorStats)MapleReactorFactory.reactorStats.get(Integer.valueOf(infoId));
            }
            if (stats == null) {
