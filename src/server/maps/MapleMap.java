...
public final class MapleMap
{
    ...
    public final void addMapObject(final MapleMapObject mapobject) {
        ...
        try {
            ((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(mapobject.getType())).put(Integer.valueOf(newOid), mapobject);
        }
        finally {
    ...
    public final void removeMapObject(final MapleMapObject obj) {
        ...
        try {
            ((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(obj.getType())).remove(obj.getObjectId());
        }
        finally {
    ...
    private void dropFromMonster(final MapleCharacter chr, final MapleMonster mob) {
        ...
        for (final MonsterDropEntry de2 : dropEntry) {
            ...
            if (de2.itemId == 0) {
                ...
                if (mesos > 0) {
                    this.spawnMobMesoDrop((int)((double)mesos * (chr.getStat().mesoBuff / 100.0) * (double)((chr.getDropMeso() < 1) ? chr.getDropMod() : 1) * (double)cmServerrate), this.calcDropPos(pos, mob.getTruePosition()), (MapleMapObject)mob, chr, false, droptype);
                    mesoDropped = true;
                }
            }
            else {
    ...
    public final void 地图杀怪(final MapleMonster monster, final MapleCharacter chr) {
        ...
        if (mobid == MapleParty.通缉BOSS && this.mapid == MapleParty.通缉地图) {
            ...
            if ((int)Integer.valueOf(FengYeDuan.ConfigValuesMap.get("屠令广播开关")) <= 0) {
    ...
    public List<MapleReactor> getAllReactorsThreadsafe() {
        ...
        try {
            for (final MapleMapObject mmo : ((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(MapleMapObjectType.REACTOR)).values()) {
    ...
    public List<MapleMapObject> getAllDoorsThreadsafe() {
        ...
        try {
            for (final MapleMapObject mmo : ((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(MapleMapObjectType.DOOR)).values()) {
                ret.add(mmo);
            }
        }
        finally {
    ...
    public List<MapleMapObject> getAllHiredMerchantsThreadsafe() {
        ...
        try {
            for (final MapleMapObject mmo : ((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(MapleMapObjectType.HIRED_MERCHANT)).values()) {
                ret.add(mmo);
            }
        }
        finally {
    ...
    public List<MapleMonster> getAllMonstersThreadsafe() {
        ...
        try {
            for (final MapleMapObject mmo : ((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(MapleMapObjectType.MONSTER)).values()) {
    ...
    public final void limitReactor(final int rid, final int num) {
        ...
        ((ReentrantReadWriteLock)this.mapObjectLocks.get(MapleMapObjectType.REACTOR)).readLock().lock();
        try {
            for (final MapleMapObject obj : ((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(MapleMapObjectType.REACTOR)).values()) {
                final MapleReactor mr = (MapleReactor)obj;
                if (contained.containsKey(mr.getReactorId())) {
                    if ((int)Integer.valueOf(contained.get(mr.getReactorId())) >= num) {
                        toDestroy.add(mr);
                    }
                    else {
                        contained.put(mr.getReactorId(), Integer.valueOf((int)Integer.valueOf(contained.get(mr.getReactorId())) + 1));
                    }
                }
                else {
                    contained.put(mr.getReactorId(), Integer.valueOf(1));
                }
            }
        }
        finally {
    ...
    public final MapleMapObject getMapObject(final int oid, final MapleMapObjectType type) {
        ...
        try {
            return (MapleMapObject)((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(type)).get(Integer.valueOf(oid));
        }
        finally {
    ...
    public final boolean containsNPC(final int npcid) {
        ...
        try {
            for (final MapleMapObject o : ((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(MapleMapObjectType.NPC)).values()) {
    ...
    public MapleMonster getMonsterById(final int id) {
        ...
        try {
            ...
            for (final MapleMapObject o : ((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(MapleMapObjectType.MONSTER)).values()) {
            	MapleMonster n = (MapleMonster)o;
                if (n.getId() == id) {
                    ret = n;
                    break;
                }
    ...
    public MapleReactor getReactorById(final int id) {
        ...
        try {
            ...
            for (final MapleMapObject o : ((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(MapleMapObjectType.REACTOR)).values()) {
            	MapleReactor n = (MapleReactor)o;
    ...
    public final void removeNpc_(final int npcid) {
        ...
        try {
            final Iterator<MapleMapObject> itr = ((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(MapleMapObjectType.NPC)).values().iterator();
            while (itr.hasNext()) {
    ...
    public List<MapleMist> getAllMistsThreadsafe() {
        ...
        try {
            for (final MapleMapObject mmo : ((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(MapleMapObjectType.MIST)).values()) {
    ...
    public final void spawnRandDrop() {
        ...
        try {
            for (final MapleMapObject o : ((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(MapleMapObjectType.ITEM)).values()) {
    ...
    public int getItemsSize() {
        return ((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(MapleMapObjectType.ITEM)).size();
    }
    
    public int getMobsSize() {
        return ((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(MapleMapObjectType.MONSTER)).size();
    }
    ...
    public List<MapleMapItem> getAllItemsThreadsafe() {
        ...
        ((ReentrantReadWriteLock)this.mapObjectLocks.get(MapleMapObjectType.ITEM)).readLock().lock();
        try {
            for (final MapleMapObject mmo : ((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(MapleMapObjectType.ITEM)).values()) {
    ...
    public final void addPlayer(final MapleCharacter chr) {
        ...
        try {
            ((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(MapleMapObjectType.PLAYER)).put(chr.getObjectId(), chr);
        }
        finally {
                        ...
                        if (!chr.isGM()) {
                            for (final 离线人偶 jr : clone) {
                                if (chr.getClient().getAccID() == jr.AccId) {
                                    chr.getClient().getChannelServer();
                                    ChannelServer.clones.remove(jr);
                                    break;
                                }
                            }
                        }
        ...
        if ((int)Integer.valueOf(FengYeDuan.ConfigValuesMap.get("地图名称开关")) == 0) {
        ...
        if (stat != null && !chr.isClone()) {
            final MapleSummon summon = (MapleSummon)chr.getSummons().get(stat.getSourceId());
    ...
    public List<MapleCharacter> getAllPlayersThreadsafe() {
        ...
        try {
            for (final MapleMapObject chr : ((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(MapleMapObjectType.PLAYER)).values()) {
    ...
    public List<MapleNPC> getAllNPCsThreadsafe() {
        ...
        ((ReentrantReadWriteLock)this.mapObjectLocks.get(MapleMapObjectType.NPC)).readLock().lock();
        try {
            for (final MapleMapObject mmo : ((LinkedHashMap<Integer, MapleMapObject>)this.mapObjects.get(MapleMapObjectType.NPC)).values()) {
    ...
    public final void toggleEnvironment(final String ms) {
        if (this.environment.containsKey(ms)) {
            this.moveEnvironment(ms, ((int)Integer.valueOf(this.environment.get(ms)) == 1) ? 2 : 1);
        }
        else {
    ...
    static {
        ...
        MapleMap.特殊宠物吸取开关 = Boolean.parseBoolean(ServerProperties.getProperty("FengYeDuan.特殊宠物吸取开关"));
        MapleMap.特殊宠物吸物开关 = Boolean.parseBoolean(ServerProperties.getProperty("FengYeDuan.特殊宠物吸物开关"));
        MapleMap.特殊宠物吸金开关 = Boolean.parseBoolean(ServerProperties.getProperty("FengYeDuan.特殊宠物吸金开关"));
        MapleMap.特殊宠物吸物无法使用地图开关 = Boolean.parseBoolean(ServerProperties.getProperty("FengYeDuan.特殊宠物吸物无法使用地图开关"));
        MapleMap.特殊宠物吸物无法使用地图 = ServerProperties.getProperty("FengYeDuan.特殊宠物吸物无法使用地图").split(",");
        MapleMap.持有物道具 = (int)Integer.valueOf(ServerProperties.getProperty("FengYeDuan.持有物道具"));
    }
