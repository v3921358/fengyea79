...
public class SkillFactory
{
                    ...
                    if (data.getName().equals("skill")) {
                        for (final MapleData subData : data) {
                            if (subData != null) {
                                ...
                                List<Integer> job = (List<Integer>)SkillFactory.summonSkills.get(Integer.valueOf(skillId / 10000));
                                if (job == null) {
    ...
    public static final List<Integer> getSkillsByJob(final int jobId) {
        return (List<Integer>)SkillFactory.summonSkills.get(Integer.valueOf(jobId));
    }
