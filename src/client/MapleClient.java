...
public class MapleClient
{
    ...
    public final void update2ndPassword() {
        try {
            ...
            Logger.getLogger(MapleClient.class.getName()).log(Level.SEVERE, null, (Throwable)ex2);
    ...
    public final void DebugMessage(final StringBuilder sb) {
        ...
        sb.append(this.getSession().attr(MapleClient.CLIENT_KEY).get() != null);
        sb.append(" loggedin: ");
    ...
    public static boolean checkHash(final String hash, final String type, final String password) {
        try {
            ...
            return HexTool.toString(digester.digest()).replace((CharSequence)" ", (CharSequence)"").toLowerCase().equals(hash);
        }
    ...
    public final void unLockDisconnect() {
        this.getSession().writeAndFlush(MaplePacketCreator.serverNotice(1, "當前账号在別處登入\r\n若不是你本人操作請及時更改密碼。"));
    ...
    static {
        MapleClient.离线挂机 = Boolean.parseBoolean(ServerProperties.getProperty("FengYeDuan.离线挂机"));
