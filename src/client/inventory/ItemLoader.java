        ...
        try (final Connection con = (Connection)DBConPool.getInstance().getDataSource().getConnection()) {
            ...
            while (rs.next()) {
                ...
                if (mit.equals(MapleInventoryType.EQUIP) || mit.equals(MapleInventoryType.EQUIPPED)) {
                    ...
                    items.put(rs.getLong("inventoryitemid"), new Pair<IItem, MapleInventoryType>(equip.copy(), mit));
                }
                else {
                    ...
                    items.put(rs.getLong("inventoryitemid"), new Pair<IItem, MapleInventoryType>(item.copy(), mit));
                }
            }
            rs.close();
            ps.close();
