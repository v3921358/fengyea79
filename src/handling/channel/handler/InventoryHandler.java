...
public class InventoryHandler
{
    ...
    public static final boolean UseRewardItem(final byte slot, final int itemId, final MapleClient c, final MapleCharacter chr) {
        ...
        if (toUse.getItemId() == 5532000) {
            c.sendPacket(MaplePacketCreator.enableActions());
            NPCScriptManager.getInstance().start(c, 3003324, "活动礼包");
        }
    ...
    public static final void UseCashItem(final LittleEndianAccessor slea, final MapleClient c) {
        ...
        switch (itemId) {
            ...
            case 5070000: {
                final int 游戏喇叭 = (int)Integer.valueOf(FengYeDuan.ConfigValuesMap.get("游戏喇叭开关"));
                if (游戏喇叭 > 0) {
            ...
            case 5077000: {
                ...
                for (int i = 0; i < numLines; ++i) {
                    ...
                    messages.add(sb + c.getPlayer().getName() + " : " + message2);
                }
            ...
            case 5320000: {
                ...
                if (!name.equals(c.getPlayer().getName())) {
    ...
    public static final void UseSkillBook(final LittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
        ...
        final int SuccessRate = (int)Integer.valueOf(skilldata.get("success"));
        final int ReqSkillLevel = (int)Integer.valueOf(skilldata.get("reqSkillLevel"));
        final int MasterLevel = (int)Integer.valueOf(skilldata.get("masterLevel"));
        byte i = 0;
        while (true) {
            final Integer CurrentLoopedSkillId = Integer.valueOf(skilldata.get("skillid" + (int)i));
            ++i;
