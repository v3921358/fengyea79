...
public class CharLoginHandler
{
    ...
    public static final void handleCreateCharacter(final LittleEndianAccessor slea, final MapleClient c) {
        final int 冒险家 = (int)Integer.valueOf(FengYeDuan.ConfigValuesMap.get("冒险家职业开关"));
        final int 战神 = (int)Integer.valueOf(FengYeDuan.ConfigValuesMap.get("战神职业开关"));
        final int 骑士团 = (int)Integer.valueOf(FengYeDuan.ConfigValuesMap.get("骑士团职业开关"));
