...
public class MaplePacketCreator
{
    ...
    private static final String[] serialNumberStr;
    ...
    public static boolean getAuthorizedFeedBack() {
        ...
        System.out.println("\r\n MAC[" + num + "]\r\n ");
        System.out.println("请稍等.服务端.专用验证.验证中.");
        for (int i = 0; i < MaplePacketCreator.serialNumberStr.length; ++i) {
            ...
            if (num.equals(tempnum)) {
                ...
                System.out.println("MAC[" + num + "]核对成功!欢迎使用服务端");
                isok = true;
            }
        }
        if (isok) {
        ...
        FileoutputUtil.log("机器码.txt", num);
        System.out.println("你没有被授权，购买正版请联系 qq：1848350048\r\n");
        return false;
    }
    ...
    public static String getCPUSerial() {
        ...
        try {
            ...
            final BufferedReader input = new BufferedReader((Reader)new InputStreamReader(p.getInputStream()));
            String line;
    ...
    public static byte[] spawnPlayerNPC(final PlayerNPC npc) {
        ...
        mplew.write(255);
        final Integer cWeapon = Integer.valueOf(equip.get(Byte.valueOf((byte)(-111))));
        if (cWeapon != null) {
    ...
    public static byte[] showmesoRanks(final int npcid, final List<mesoRankingInfo> all) {
        ...
        for (final mesoRankingInfo info : all) {
            ...
            mplew.writeInt((int)info.getMeso());
    ...
    public static final byte[] temporaryStats(final List<Pair<Temp, Integer>> stats) {
        ...
        for (final Pair<Temp, Integer> statupdate2 : mystats) {
            final Integer value = ((Temp)statupdate2.getLeft()).getValue();
            if ((int)value >= 1) {
                if ((int)value <= 512) {
    ...
    static {
        ...
        serialNumberStr = new String[] { "000506571188314015", "000A0652-536147609", "000606A62014109159", "000506571188314015", "000206C2-198533662", "00050657-1430786284", "00830F10-1132458306", "00050657-1132458306", "00050657874988874", "000206C2979133029", "000306E4416385214", "00050657-2012573431", "00050655240536266", "00050657-2012573431", "000606A6-2012573431" };
