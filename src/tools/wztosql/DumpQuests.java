                    ...
                    for (final MapleData req : reqData.getChildren()) {
                        ...
                        if (req.getName().equals("job")) {
                            ...
                            for (int x = 0; x < child.size(); ++x) {
                                dataStore.add(new Pair<Integer, Integer>(Integer.valueOf(i), MapleDataTool.getInt((MapleData)child.get(x), -1)));
                            }
                        }
                            ...
                            for (int x = 0; x < child.size(); ++x) {
                                final MapleData childdata = (MapleData)child.get(x);
                                if (childdata != null) {
                                    dataStore.add(new Pair<Integer, Integer>(Integer.valueOf(i), MapleDataTool.getInt(childdata.getChildByPath("id"), 0)));
                                }
                            }
                        }
