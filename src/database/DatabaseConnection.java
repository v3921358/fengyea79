...
public class DatabaseConnection
{
    ...
    public static Connection getConnection() {
        ...
        ConWrapper ret = (ConWrapper)DatabaseConnection.connections.get(Integer.valueOf(threadID));
        if (ret == null) {
    ...
    private static Connection connectToDB() {
        if (!DatabaseConnection.propsInited) {
            ...
            DatabaseConnection.dbUser = DatabaseConnection.dbProps.getProperty("FengYeDuan.db.user");
            DatabaseConnection.dbPass = DatabaseConnection.dbProps.getProperty("FengYeDuan.db.password");
            try {
    ...
    public static void closeTimeout() {
        ...
        try {
            for (final Integer tid : keys) {
                final ConWrapper con = (ConWrapper)DatabaseConnection.connections.get(tid);
                if (con.close()) {
                    ++i;
                }
            }
