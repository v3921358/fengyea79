...
public class EventInstanceManager
{
    ...
    public void monsterKilled(final MapleCharacter chr, final MapleMonster mob) {
        ...
        try {
            try {
                Integer kc = Integer.valueOf(this.killCount.get(chr.getId()));
                final int inc = (int)(Integer)this.em.getIv().invokeFunction("monsterValue", this, mob.getId());
                if (this.disposed) {
                    return;
                }
                if (kc == null) {
    ...
    public void monsterDamaged(final MapleCharacter chr, final MapleMonster mob, final int damage) {
        ...
        try {
            this.em.getIv().invokeFunction("monsterDamaged", this, chr, mob.getId(), Integer.valueOf(damage));
        }
        catch (RejectedExecutionException ex4) {}
    ...
    public int getKillCount(final MapleCharacter chr) {
        ...
        final Integer kc = Integer.valueOf(this.killCount.get(chr.getId()));
        if (kc == null) {
            return 0;
        }
        return (int)kc;
